# FileAI Documentation

Welcome to the FileAI documentation!
...
- [API Reference](./api.md)
- [Plugin Development](./extending.md)

## Getting Help

- [GitHub Issues](https://github.com/hashcott/fileai/issues) - Report bugs
- [GitHub Discussions](https://github.com/hashcott/fileai/discussions) - Ask questions
- [Discord](https://discord.gg/fileai) - Community chat

## Assets

The `assets/` folder contains:

- `logo.svg` - FileAI logo
